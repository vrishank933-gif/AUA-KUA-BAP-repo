...
module.exports.submitApplication = async (req, res) => {
  ...
  try {
    ...
    // Prevent duplicate applicant_details for same user
    ...
    // =========================
    // 3) applicant_asa_name (single or array)
    // =========================
    ...
    // =========================
    // 5) applicant_authentication_details
    // =========================
    ...
    // =========================
    // 6) applicant_declaration_understandings
    // =========================
    ...
    // Insert only if a file is provided; make it required if business rules demand.
